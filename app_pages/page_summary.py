...
def page_summary_body():
    ...
    st.write("Fantasy sports is a huge industry. In 2022, the size of the "
            ...
            "winning team.")
    st.write("We used various techniques from machine learning to address the"
    ...
    # Content
    st.write("## Dataset")
    st.info("We used a dataset from Kaggle generated by Wyatt Walsh using the"
        " NBA api. Here is a sampling.")
    st.dataframe(game_data.head(10))
    st.info("* **Dataset**: The data is all publicly available [here]"
    ...
    st.write("## Features")
    st.write("- `game_id`: a unique identifier of each game record, also "
