...
def page_conclusions_body():
    ...
    st.write("The project was a success as we were able to validate all of "
             "our hypohteses. We were able to deploy a predictor for games "
             "which the classification models have not yet seen.")
    st.write("## Business Requirements")
    st.success("- **Business Requirement 1**: This requirement was met in two "
    ...
    st.info("The models performed well. I would have liked to have done a more"
